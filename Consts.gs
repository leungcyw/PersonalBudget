...
const DATASTORE_TEMP_CELL = 'I1';
const DATASTORE_TEMP_RANGE = 'I1:I';
const DATASTORE_TEMP_ROW = 1;
const DATASTORE_TEMP_COL1 = 9;
const DATASTORE_TEMP_COL2 = 10;
const DATASTORE_TEMP_TWO_COLS = 2;
const DATASTORE_MONTH_KEY_RANGE = 'E1:E';
const DATASTORE_MONTH_VAL_RANGE = 'F1:F';
const DATASTORE_YEAR_KEY_RANGE = 'G1:G';
const DATASTORE_YEAR_VAL_RANGE = 'H1:H';
const DATASTORE_MONTH_KEY_COL = 5;
const DATASTORE_MONTH_VAL_COL = 6;
const DATASTORE_YEAR_KEY_COL = 7;
const DATASTORE_YEAR_VAL_COL = 8;
...
const FORM_YEAR_CATEGORY_EXPENSE_SQL = 'select B,D where YEAR(A) = YEAR(date \'"&TEXT(TODAY(), "yyyy-mm-dd")&"\') and B != \'Income\'';
...
const DATASTORE_YEAR_GRAPH_ROW_POS = 31;
const DATASTORE_YEAR_GRAPH_COL_POS = 1;
const MONTH_GRAPH_TITLE = 'Current Month: Expense Breakdown';
const YEAR_GRAPH_TITLE = 'Current Year: Expense Breakdown';
const MONTH_GRAPH_COL_RANGE = [4, 8];
const BAR_GRAPH_TITLE = 'Current Year: Income vs. Expenses';
